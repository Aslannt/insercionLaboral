...
var __PRIVATE_IndexBackfiller = class {
  ...
  oe(e, t) {
    ...
    return PersistencePromise.doWhile(() => true === i && r > 0, () => this.localStore.indexManager.getNextCollectionGroupToUpdate(e).next((t2) => {
      if (null !== t2 && !n.has(t2))
        return __PRIVATE_logDebug(W, `Processing collection: ${t2}`), this._e(e, t2, r).next((e2) => {
          r -= e2, n.add(t2);
        });
      i = false;
    })).next(() => t - r);
...
function __PRIVATE_queryNormalizedOrderBy(e) {
  ...
  if (null === t.Ee) {
    ...
    for (const n2 of t.explicitOrderBy)
      t.Ee.push(n2), e2.add(n2.field.canonicalString());
...
function __PRIVATE_fromDbRemoteDocument(e, t) {
  let n;
  if (t.document)
    n = __PRIVATE_fromDocument(e.wt, t.document, !!t.hasCommittedMutations);
...
var __PRIVATE_FirestoreIndexValueWriter = class {
  ...
  Ct(e, t) {
    if ("nullValue" in e)
      ...
      this.Mt(t, 10), t.xt(e.booleanValue ? 1 : 0);
    else if ("integerValue" in e)
      this.Mt(t, 15), t.xt(__PRIVATE_normalizeNumber(e.integerValue));
      ...
      this.Nt(e.stringValue, t), this.Bt(t);
    else if ("bytesValue" in e)
      this.Mt(t, 30), t.Lt(__PRIVATE_normalizeByteString(e.bytesValue)), this.Bt(t);
      ...
      "mapValue" in e ? __PRIVATE_isMaxValue(e) ? this.Mt(t, Number.MAX_SAFE_INTEGER) : __PRIVATE_isVectorValue(e) ? this.qt(e.mapValue, t) : (this.Qt(e.mapValue, t), this.Bt(t)) : "arrayValue" in e ? (this.$t(e.arrayValue, t), this.Bt(t)) : fail(19022, {
        Ut: e
      });
  }
  Nt(e, t) {
  ...
  Zt(e) {
    for (const t of e) {
      ...
      if (e2 < 128)
        ...
        this.zt(960 | e2 >>> 6), this.zt(128 | 63 & e2);
      else if (t < "\uD800" || "\uDBFF" < t)
        this.zt(480 | e2 >>> 12), this.zt(128 | 63 & e2 >>> 6), this.zt(128 | 63 & e2);
      else {
  ...
  wn(e) {
    ...
    if (this.fn.size > 0) {
      ...
      if (!r.has(e2.field.canonicalString())) {
        const t2 = n[i];
        if (!this.bn(e2, t2) || !this.Dn(this.gn[s++], t2))
          return false;
      }
      ++i;
    }
    for (; i < n.length; ++i) {
      const e2 = n[i];
      if (s >= this.gn.length || !this.Dn(this.gn[s++], e2))
        return false;
    }
    return true;
  }
...
var __PRIVATE_IndexedDbIndexManager = class {
  ...
  Bn(e, t, n) {
    ...
    for (const s of __PRIVATE_fieldIndexGetDirectionalSegments(e)) {
      const e2 = n[i++];
      for (const n2 of r)
        if (this.Kn(t, s.fieldPath) && isArray(e2))
          r = this.Wn(r, s, e2);
        else {
    ...
    if (null != i) {
      ...
      if (isArray(s))
        for (const i2 of s.arrayValue.values || [])
          n = n.add(new __PRIVATE_IndexEntry(t.indexId, e.key, this.kn(i2), r));
    } else
...
var __PRIVATE_LruGarbageCollectorImpl = class {
  ...
  nthSequenceNumber(e, t) {
    if (0 === t)
      return PersistencePromise.resolve(__PRIVATE_ListenSequence.le);
...
var __PRIVATE_MemoryMutationQueue = class {
  ...
  addMutationBatch(e, t, n, r) {
    ...
    for (const t2 of r)
      this.Xr = this.Xr.add(new __PRIVATE_DocReference(t2.key, i)), this.indexManager.addToCollectionParentIndex(e, t2.key.path.popLast());
...
var __PRIVATE_IndexedDbPersistence = class ___PRIVATE_IndexedDbPersistence {
  constructor(e, t, n, r, i, s, o, _, a, u, c = 18) {
    ...
    this.$i = (e2) => Promise.resolve(), !___PRIVATE_IndexedDbPersistence.C())
  ...
  async rs() {
    if (this.isPrimary && !this.ss(this.Qi, Bt)) {
      ...
      if (this.Wi)
        for (const t of e)
          this.Wi.removeItem(this.us(t.clientId));
    }
  }
  /**
  ...
  Zi(e) {
    ...
    return __PRIVATE_primaryClientStore(e).get(J).next((t) => {
      if (null !== t && this.ss(t.leaseTimestampMs, Lt) && !this.cs(t.ownerId)) {
        if (this.ts(t) && this.networkEnabled)
          return true;
        if (!this.ts(t)) {
  ...
  runTransaction(e, t, n) {
    ...
    return this.Ki.runTransaction(e, r, i, (r2) => (s = new __PRIVATE_IndexedDbTransaction(r2, this.li ? this.li.next() : __PRIVATE_ListenSequence.le), "readwrite-primary" === t ? this.Yi(s).next((e2) => !!e2 || this.Zi(s)).next((t2) => {
      if (!t2)
        throw __PRIVATE_logError(`Failed to obtain primary lease for action '${e}'.`), this.isPrimary = false, this.xi.enqueueRetryable(() => this.$i(false)), new FirestoreError(N.FAILED_PRECONDITION, $);
      return n(s);
  ...
  Es(e) {
    return __PRIVATE_primaryClientStore(e).get(J).next((e2) => {
      if (null !== e2 && this.ss(e2.leaseTimestampMs, Lt) && !this.cs(e2.ownerId) && !this.ts(e2) && !(this.Ni || this.allowTabSynchronization && e2.allowTabSynchronization))
        throw new FirestoreError(N.FAILED_PRECONDITION, kt);
    });
  }
  /**
...
var __PRIVATE_QueryEngine = class {
  ...
  getDocumentsMatchingQuery(e, t, n, r) {
    ...
    return this.ws(e, t).next((e2) => {
      ...
      if (!i.result)
        return this.Ss(e, t, r, n).next((e2) => {
          i.result = e2;
        });
    }).next(() => {
      if (i.result)
      ...
      return this.bs(e, t, n2).next((r2) => {
        if (i.result = r2, this.fs)
          return this.Ds(e, t, n2, r2.size);
      });
    }).next(() => i.result);
  }
  Ds(e, t, n, r) {
...
function __PRIVATE_localStoreExecuteQuery(e, t, n) {
  ...
  return r.persistence.runTransaction(
    ...
    (e2) => function __PRIVATE_localStoreGetTargetData(e3, t2, n2) {
      ...
      if (t2)
        return i = t2.lastLimboFreeSnapshotVersion, r.Ti.getMatchingKeysForTargetId(e2, t2.targetId).next((e3) => {
          s = e3;
        });
...
async function __PRIVATE_localStoreSaveNamedQuery(e, t, n = __PRIVATE_documentKeySet()) {
  ...
  return i.persistence.runTransaction("Save named query", "readwrite", (e2) => {
    ...
    if (r.snapshotVersion.compareTo(s) >= 0)
      return i.Ei.saveNamedQuery(e2, t);
...
var __PRIVATE_WebStorageSharedClientState = class {
  ...
  Zs(e) {
    ...
    if (t.storageArea === this.storage) {
      if (__PRIVATE_logDebug(Gt, "EVENT", t.key, t.newValue), t.key === this.no)
  ...
  async yo(e) {
    if (e.user.uid === this.currentUser.uid)
      return this.syncEngine.Co(e.batchId, e.state, e.error);
    ...
    return __PRIVATE_unguardedEventListen(c, WebChannel.EventType.OPEN, () => {
      ...
      if (!h) {
        ...
        if (o2) {
          ...
          __PRIVATE_logDebug(Yt, `RPC '${e}' stream ${r} received:`, i2), P.c_(i2);
      }
...
async function __PRIVATE_onWatchStreamChange(e, t, n) {
  ...
  else if (t instanceof __PRIVATE_DocumentWatchChange ? e.Aa.Xe(t) : t instanceof __PRIVATE_ExistenceFilterChange ? e.Aa.ot(t) : e.Aa.nt(t), !n.isEqual(SnapshotVersion.min()))
    try {
...
var __PRIVATE_BundleLoader = class {
  ...
  $a(e) {
    ...
    if (e.ka.namedQuery)
      this.queries.push(e.ka.namedQuery);
      ...
      e.ka.document && (this.documents[this.documents.length - 1].document = e.ka.document, ++t);
...
async function __PRIVATE_syncEngineUnlisten(e, t, n) {
  ...
  if (s.length > 1)
    return r.cu.set(i.targetId, s.filter((e2) => !__PRIVATE_queryEquals(e2, t))), void r.uu.delete(t);
...
function __PRIVATE_removeAndCleanupTarget(e, t, n = null) {
  ...
  for (const r of e.cu.get(t))
    e.uu.delete(r), n && e.au.Vu(r, n);
...
function __PRIVATE_updateTrackedLimbos(e, t, n) {
  for (const r of n)
    if (r instanceof __PRIVATE_AddedLimboDocument)
      e.Tu.addReference(r.key, t), __PRIVATE_trackLimboChange(e, r);
...
var __PRIVATE_ParseContextImpl = class ___PRIVATE_ParseContextImpl {
  ...
  dc(e) {
    if (0 === e.length)
      throw this.Vc("Document fields must not be empty");
    if (__PRIVATE_isWrite(this.hc) && cn.test(e))
      throw this.Vc('Document fields cannot begin and end with "__"');
  }
};
...
var __PRIVATE_DeleteFieldValueImpl = class ___PRIVATE_DeleteFieldValueImpl extends FieldValue {
  _toFieldTransform(e) {
    if (2 !== e.hc)
      throw 1 === e.hc ? e.Vc(`${this._methodName}() can only appear at the top level of your update data`) : e.Vc(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);
...
function __PRIVATE_parseData(e, t) {
  ...
  if (e instanceof FieldValue)
    return function __PRIVATE_parseSentinelFieldValue(e2, t2) {
      if (!__PRIVATE_isWrite(t2.hc))
        throw t2.Vc(`${e2._methodName}() can only be used with update() and set()`);
      if (!t2.path)
        throw t2.Vc(`${e2._methodName}() is not currently supported inside arrays`);
  ...
  if (
    ...
    if (t.settings.Ec && 4 !== t.hc)
      throw t.Vc("Nested arrays are not supported");
  ...
  return function __PRIVATE_parseScalarValue(e2, t2) {
    ...
    if (e2 instanceof DocumentReference) {
      ...
      if (!r.isEqual(n))
        throw t2.Vc(`Document reference is for database ${r.projectId}/${r.database} but should be for database ${n.projectId}/${n.database}`);
      return {
            ...
            [Tt]: {
              arrayValue: {
                values: e3.toArray().map((e4) => {
                  if ("number" != typeof e4)
                    throw t3.Vc("VectorValues must only contain numeric values.");
